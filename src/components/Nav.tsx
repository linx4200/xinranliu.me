    ...
    >
      ...
      <>
        ...
        <ul className={`
            ...
            ${isHomePage ? 'lg:hidden' : 'lg:opacity-100 lg:scale-100 lg:translate-y-0 lg:visible lg:static lg:mt-0 lg:w-auto lg:p-0 lg:border-none lg:shadow-none lg:flex-row lg:bg-transparent lg:gap-15'}
          `}
        >
          {
            pages.map(page => {
        ...
        {!isHomePage && <div className='hidden lg:block text-stone-300' aria-hidden="true">|</div>}
      </>
